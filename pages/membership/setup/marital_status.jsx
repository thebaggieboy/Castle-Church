...
<Modal show={openModal} onClose={() => setOpenModal(false)}>
    ...
    <Modal show={openModal3} onClose={() => setOpenModal3(false)}>
        <Modal.Header>Delete marital status</Modal.Header>
        <Modal.Body>
          <div className="p-5">
        
<section class="bg-white p-5 dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 px-4">
        <h4 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-2xl dark:text-white">You are about to delete this marital status, do you want to continue?</h4>
      ...
      <Modal show={openModal2} onClose={() => setOpenModal2(false)}>
        <Modal.Header>Edit a new marital status</Modal.Header>
        <Modal.Body>
          <div className="p-5">
