...
<Modal show={openModal} onClose={() => setOpenModal(false)}>
        <Modal.Header>Setup a new user Church</Modal.Header>
        <Modal.Body>
          <div className="p-5">
          <form action="#" className=''>
            ...
            <div class="w-full">
                ...
                <label for="name" class=" mb-2 inline text-xs font-medium text-gray-900 dark:text-white">Church: </label>
...
<section class="bg-white p-5 dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 px-4">
      ...
      <Modal show={openModal2} onClose={() => setOpenModal2(false)}>
        <Modal.Header>Edit church</Modal.Header>
        <Modal.Body>
          <div className="p-5">
