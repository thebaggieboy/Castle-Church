...
<section class="bg-gray-50 dark:bg-gray-900 sm:p-5 ">
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
      ...
      <Tabs aria-label="Tabs with icons" style="underline">
        ...
        <Modal show={openModal} onClose={() => setOpenModal(false)}>
        <Modal.Header>Setup a new Group</Modal.Header>
        <Modal.Body>
          <div className="p-5">
          <form action="#" className=''>
            <div class="grid gap-2 sm:grid-cols-2 sm:gap-6">
            <div class="w-full">
                ...
                {isMember == false ? <>
                    <div className='pt-2'>
                    <label for="name" class=" mb-2 inline text-xs font-medium text-gray-900 dark:text-white">Group Level: </label>
                    <input type="text" name="name" id="name" class=" inline bg-gray-50 border border-gray-300 text-gray-900 text-xs h-7 focus:ring-primary-600 focus:border-primary-600 block l dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required=""/>
                    </div>
                </> : ""}
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-white uppercase bg-gray-700 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Group Level</th>
    ...
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
      ...
      <Modal show={openModal} onClose={() => setOpenModal(false)}>
        <Modal.Header>Setup a new user Occupation</Modal.Header>
        <Modal.Body>
          <div className="p-5">
          <form action="#" className=''>
            <div class="grid gap-2 sm:grid-cols-2 sm:gap-6">
        ...
        <div class="bg-white dark:bg-gray-800   sm:rounded-lg overflow-hidden">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-xs text-gray-900 whitespace-nowrap dark:text-white">Self Employed</th>
                        
                        </tr>
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-xs text-gray-900 whitespace-nowrap dark:text-white">Unemployed</th>
                        
                        </tr>
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-xs text-gray-900 whitespace-nowrap dark:text-white">Student</th>
