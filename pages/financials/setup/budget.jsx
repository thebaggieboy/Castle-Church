...
<Modal show={openModal} onClose={() => setOpenModal(false)}>
        <Modal.Header>Setup a new Budget</Modal.Header>
        <Modal.Body>
          <div className="p-5">
          <form action="#" className=''>
            ...
            <div class="w-full">
                ...
                <label for="name" class="ml-2 mb-2 inline text-xs font-medium text-gray-900 dark:text-white">Event: </label>
                         ...
                         <select id="category" class="inline bg-gray-50 border border-gray-300 text-gray-900 text-xs  focus:ring-primary-500 focus:border-primary-500 block  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                             ...
                             <option selected="">Baby Harvest </option>
                             <option selected="">Juvenile Harvest</option>
                              
                             
                         </select>
                         <label for="name" class="ml-2 mb-2 inline text-xs font-medium text-gray-900 dark:text-white">Year: </label>
                        ...
                        <div className="p-2">
                        <label for="name" class=" mb-2 inline text-xs font-medium text-gray-900 dark:text-white">Event Date: </label>
                       
                        <Datepicker className='p-0'/>

                        </div>
                <label for="name" class="ml-2 mb-2 inline text-xs font-medium text-gray-900 dark:text-white">Income: </label>
                ...
                <label for="name" class="ml-2 mb-2 inline text-xs font-medium text-gray-900 dark:text-white">Expenditure: </label>
                <input type="email" name="name" id="name" class=" inline bg-gray-50 border border-gray-300 text-gray-900 text-xs h-7 focus:ring-primary-600 focus:border-primary-600 block  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required=""/>
