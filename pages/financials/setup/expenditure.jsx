...
<Modal show={openModal} onClose={() => setOpenModal(false)}>
        <Modal.Header>Setup a new Expenditure</Modal.Header>
        <Modal.Body>
          <div className="p-5">
          <form action="#" className=''>
            ...
            <div class="w-full">
                ...
                <label for="name" class=" mb-2 inline text-xs font-medium text-gray-900 dark:text-white">Expenditure: </label>
                ...
                <label for="name" class=" mb-2 inline text-xs font-medium text-gray-900 dark:text-white">Account Type: </label>
...
<div className="mt-5">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-white uppercase bg-gray-700 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-3">Fund Type Name</th>
