...
<section  class=" bg-cover bg-[url('https://images.pexels.com/photos/133699/pexels-photo-133699.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')] ">
    <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-yellow-100 md:text-5xl lg:text-6xl">More Time for Ministry, Less Time for Admin.</h1>
       <br/>
        <div class="flex flex-col space-y-4 mt-10 sm:flex-row sm:justify-center sm:space-y-0">
            <a style={{backgroundColor:"beige"}} href="/accounts/signup" class="inline-flex justify-center items-center py-3 px-5 text-base text-center text-black font-bold rounded-lg hover:bg-yellow-400 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
               Find a service
