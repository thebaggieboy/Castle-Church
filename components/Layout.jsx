...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-42 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-black dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <Link href="/admin" class={`flex items-center p-2 ${path_ == "/admin" ? activeLink : 'text-white ' } rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group`}>
            <svg class={`w-[30px] h-[30px] ${path_ == "/admin" ? iconColor : 'text-white'} dark:text-white`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  ...
  <path fill-rule="evenodd" d="M9 16a6 6 0 1 1 12 0 6 6 0 0 1-12 0Zm6-3a1 1 0 0 1 1 1v1h1a1 1 0 1 1 0 2h-1v1a1 1 0 1 1-2 0v-1h-1a1 1 0 1 1 0-2h1v-1a1 1 0 0 1 1-1Z" clip-rule="evenodd"/>
          ...
          <hr />
         <li>
            <Link href="/logout" class={`flex items-center p-2 ${path_ == "/logout" ? activeLink : 'text-white ' } rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group`}>
